...
/// <summary>
/// Adjuntado al objeto "obstacles" por InfernoBeatManager.
/// En cada beat escala brevemente todos los hijos (spikes) para dar feedback visual al ritmo.
/// </summary>
public class InfernoBeatScalePulse : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (InfernoBeatManager.Instance != null)
            InfernoBeatManager.Instance.OnBeat += Pulse;
        else
            Debug.LogWarning("[InfernoBeatScalePulse] InfernoBeatManager no encontrado al iniciar.");
    }
